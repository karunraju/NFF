...
class InceptionFilter(nn.Module):
    def __init__(self, activation=nn.ReLU):
        ...
        self.cnn2 = nn.Sequential(nn.Conv2d(3, 8, kernel_size=1, stride=1, padding=0, bias=True), self.Activation(),
                                  nn.Conv2d(8, 16, kernel_size=3, stride=1, padding=1, bias=True), self.Activation())
        self.cnn3 = nn.Sequential(nn.Conv2d(3, 8, kernel_size=1, stride=1, padding=0, bias=True), self.Activation(),
