...
class InceptionFilter(nn.Module):
    def __init__(self, activation=nn.ReLU):
        ...
        self.cnn2 = nn.Sequential(nn.Conv2d(3, 4, kernel_size=1, stride=1, padding=0, bias=True), self.Activation(),
                                  nn.Conv2d(4, 4, kernel_size=3, stride=1, padding=1, bias=True), self.Activation())
        self.cnn3 = nn.Sequential(nn.Conv2d(3, 4, kernel_size=1, stride=1, padding=0, bias=True), self.Activation(),
                                  nn.Conv2d(4, 4, kernel_size=5, stride=1, padding=2, bias=True), self.Activation())
        self.cnn4 = nn.Sequential(nn.MaxPool2d(kernel_size=3, stride=1, padding=1), self.Activation(),
                                  nn.Conv2d(3, 4, kernel_size=1, stride=1, padding=0, bias=True), self.Activation())
